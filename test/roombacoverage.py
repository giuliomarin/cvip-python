...
outDir = '/Users/giulio/Desktop/roomba'
if not os.path.exists(outDir):
    os.makedirs(outDir)

# construct the argument parser and parse the arguments
ap = argparse.ArgumentParser()
ap.add_argument("-v", "--video", help="path to the video file", default="/Users/giulio/Desktop/roomba.mov")
ap.add_argument("-a", "--minarea", type=int, default=100, help="minimum area size")
ap.add_argument("-w", "--weightnew", type=float, default=0.02, help="weight new frame background")
...
while True:
    ...
    frame = utils.resizeimgw(frame, 640)
